...
Here are the main resources that helped me to organize my SASS files:
* CSS CODING STANDARDS            -> https://drupal.org/node/1886770
* INUIT.CSS                       -> http://inuitcss.com/
* ROCK HAMMER                     -> http://malarkey.github.io/Rock-Hammer/
* GITHUB CSS STYLEGUIDE           -> https://github.com/styleguide/css
* STRUCTURE A SASS PROJECT        -> http://thesassway.com/beginner/how-to-structure-a-sass-project
...
- partials/_global.scss         => global/generic elements like navigation, logo or custom elements
...
- partials/_animation.scss      => all your CSS3 animation functions
...
- vendor/_compass.scss    => Learn everything about Compass here: http://compass-style.org/
